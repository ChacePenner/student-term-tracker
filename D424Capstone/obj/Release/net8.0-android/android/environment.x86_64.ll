...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 610, ; uint32_t number_of_dso_cache_entries (0x262)
	i32 33555165, ; uint32_t android_runtime_jnienv_class_token (0x20002dd)
	i32 100670826, ; uint32_t jnienv_initialize_method_token (0x6001d6a)
	i32 100670825, ; uint32_t jnienv_registerjninatives_method_token (0x6001d69)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [610 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Security.Cryptography.Algorithms.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Security.Cryptography.Primitives.dll.so
		ptr null; void* handle (0x0)
	}, ; 98
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4653218859990629377, ; hash 0x40938de63be3bc01, from name: D424Capstone
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-D424Capstone.dll.so
		ptr null; void* handle (0x0)
	}, ; 165
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6049325392920127292, ; hash 0x53f38564e7c1273c, from name: aot-D424Capstone
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-D424Capstone.dll.so
		ptr null; void* handle (0x0)
	}, ; 195
	...
	%struct.DSOCacheEntry {
		i64 6861922720812840020, ; hash 0x5f3a725bca3b3454, from name: aot-D424Capstone.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-D424Capstone.dll.so
		ptr null; void* handle (0x0)
	}, ; 217
	...
	%struct.DSOCacheEntry {
		i64 9336199411242711635, ; hash 0x8190d7e633553a53, from name: D424Capstone.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-D424Capstone.dll.so
		ptr null; void* handle (0x0)
	}, ; 320
	...
	%struct.DSOCacheEntry {
		i64 9980529378497788441, ; hash 0x8a81f69733b5fa19, from name: libaot-D424Capstone.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-D424Capstone.dll.so
		ptr null; void* handle (0x0)
	}, ; 337
	...
	%struct.DSOCacheEntry {
		i64 14065731195561838993, ; hash 0xc33383ffb9980991, from name: libaot-D424Capstone
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-D424Capstone.dll.so
		ptr null; void* handle (0x0)
	}, ; 475
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0fa3875e-45ab-481b-bcf3-aa2654a436f9\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-D424Capstone.dll.so\00", align 16
...
@.DSOCacheEntry.88_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Algorithms.dll.so\00", align 16
@.DSOCacheEntry.89_name = private unnamed_addr constant [54 x i8] c"libaot-System.Security.Cryptography.Primitives.dll.so\00", align 16
